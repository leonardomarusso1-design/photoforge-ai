...
export const templates = [
  ...
  { name: "Casual Urbano", category: "Casual", subtype: "urbano", description: "Foto espontanea em ambiente urbano com aparencia natural.", image: "/assets/landing/template-casual.png", credits: 8 },
  ...
  { name: "Casual Cafe", category: "Casual", subtype: "cafe", description: "Ensaio lifestyle em cafeteria, ideal para redes sociais.", image: "/assets/landing/template-casual.png", credits: 8 },
  { name: "Praia Lifestyle", category: "Praia", subtype: "lifestyle", description: "Foto aberta na praia, com ambiente visivel e luz natural.", image: "/assets/landing/template-praia.png", credits: 10 },
  { name: "Praia Editorial", category: "Praia", subtype: "editorial", description: "Visual sofisticado na praia com composicao editorial.", image: "/assets/landing/template-praia.png", credits: 10 },
  { name: "Profissional Premium", category: "Profissional/empresa", subtype: "perfil", description: "Imagem profissional para perfil, LinkedIn e autoridade.", image: "/assets/landing/template-profissional.png", credits: 10, popular: true, badge: "Ideal para perfil" },
  { name: "LinkedIn/Corporativo", category: "Profissional/empresa", subtype: "linkedin", description: "Foto corporativa limpa para perfil profissional.", image: "/assets/landing/template-profissional.png", credits: 8 },
  { name: "Casal Editorial", category: "Casal", subtype: "editorial", description: "Ensaio de casal com clima romantico e acabamento editorial.", image: "/assets/landing/template-casal.png", credits: 12 },
  { name: "Gestante Elegante", category: "Gestante", subtype: "elegante", description: "Foto gestante delicada, elegante e realista.", image: "/assets/landing/template-gestante.png", credits: 12 },
  ...
  { name: "Fitness Academia", category: "Fitness", subtype: "academia", description: "Foto esportiva realista com energia e composicao limpa.", image: "/assets/landing/template-fitness.png", credits: 10 },
  { name: "Recriar Referencia", category: "Personalizado", subtype: "referencia", description: "Use quando a cliente mandar uma inspiracao e pedir algo parecido. A IA usa a referencia so para pose, roupa, ambiente e luz, preservando rosto, corpo, cabelo e idade da cliente.", image: "/assets/landing/gallery-preview.png", credits: 12, popular: true, badge: "Mais usado por clientes" },
  { name: "Prompt Personalizado", category: "Personalizado", subtype: "avancado", description: "Crie um ensaio do zero ajustando cenario, roupa, pose, expressao e detalhes manualmente.", image: "/assets/landing/hero-dashboard.png", credits: 10, badge: "Avancado" }
